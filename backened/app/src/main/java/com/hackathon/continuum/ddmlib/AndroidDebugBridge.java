...
public final class AndroidDebugBridge {
     ...
     * with {@link com.hackathon.continuum.ddmlib.AndroidDebugBridge} changes.
     */
    public interface IDebugBridgeChangeListener {
        /**
         * Sent when a new {@link com.hackathon.continuum.ddmlib.AndroidDebugBridge} is connected.
         * <p/>
         * This is sent from a non UI thread.
         * @param bridge the new {@link com.hackathon.continuum.ddmlib.AndroidDebugBridge} object.
         */
    ...
    public interface IDeviceChangeListener {
        /**
         * Sent when the a device is connected to the {@link com.hackathon.continuum.ddmlib.AndroidDebugBridge}.
         * <p/>
         * This is sent from a non UI thread.
     ...
     * @see com.hackathon.continuum.ddmlib.AndroidDebugBridge#createBridge(String, boolean)
     * @see DdmPreferences
     */
    ...
    /**
     * Creates a {@link com.hackathon.continuum.ddmlib.AndroidDebugBridge} that is not linked to any particular executable.
    ...
    public static AndroidDebugBridge createBridge(String osLocation, boolean forceNewBridge) {
        synchronized (sLock) {
            ...
            try {
                sThis = new AndroidDebugBridge(osLocation);  //creates the tcp connection and get a list of devices
                sThis.start();
            } catch (InvalidParameterException e) {
                sThis = null;
            }
     ...
     * {@link com.hackathon.continuum.ddmlib.AndroidDebugBridge} is connected, by sending it one of the messages defined
     * in the {@link com.hackathon.continuum.ddmlib.AndroidDebugBridge.IDebugBridgeChangeListener} interface.
     ...
     * {@link com.hackathon.continuum.ddmlib.AndroidDebugBridge} is started.
     ...
     * by sending it one of the messages defined in the {@link com.hackathon.continuum.ddmlib.AndroidDebugBridge.IDeviceChangeListener} interface.
     * @param listener The listener which should be notified.
     */
     ...
     * {@link com.hackathon.continuum.ddmlib.AndroidDebugBridge.IClientChangeListener} interface.
     * @param listener The listener which should be notified.
     */
     ...
     * {@link com.hackathon.continuum.ddmlib.AndroidDebugBridge.IDeviceChangeListener} object.
     */
    ...
    /**
     * Returns the number of times the {@link com.hackathon.continuum.ddmlib.AndroidDebugBridge} object attempted to connect
     * to the adb daemon.
     */
    ...
    /**
     * Returns the number of times the {@link com.hackathon.continuum.ddmlib.AndroidDebugBridge} object attempted to restart
     * the adb daemon.
     */
   ...
   /**
     ...
     * the {@link com.hackathon.continuum.ddmlib.AndroidDebugBridge} lock. Access to this lock is done through {@link #getLock()}.
