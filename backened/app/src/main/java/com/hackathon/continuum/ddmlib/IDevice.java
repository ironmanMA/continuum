...
import com.hackathon.continuum.ddmlib.log.LogReceiver;
...
public interface IDevice {
    ...
    /** Device change bit mask: {@link com.hackathon.continuum.ddmlib.IDevice.DeviceState} change. */
    ...
    public static enum DeviceState {
        ...
        /**
         * Returns a {@link com.hackathon.continuum.ddmlib.IDevice.DeviceState} from the string returned by <code>adb devices</code>.
         * @param state the device state.
         * @return a {@link com.hackathon.continuum.ddmlib.IDevice.DeviceState} object or <code>null</code> if the state is unknown.
         */
     ...
     * @return <code>true</code> if {@link #getState()} returns {@link com.hackathon.continuum.ddmlib.IDevice.DeviceState#ONLINE}.
     */
     ...
     * @return <code>true</code> if {@link #getState()} returns {@link com.hackathon.continuum.ddmlib.IDevice.DeviceState#OFFLINE}.
     */
    public boolean isOffline();

    /**
     * Returns if the device is in bootloader mode.
     * @return <code>true</code> if {@link #getState()} returns {@link com.hackathon.continuum.ddmlib.IDevice.DeviceState#BOOTLOADER}.
     */
     ...
     * refuse to open the connection because the {@link com.hackathon.continuum.ddmlib.IDevice} is invalid (or got disconnected).
     ...
     * @throws java.io.IOException if fatal error occurred when pushing file
     */
     ...
     * @throws java.io.IOException if file removal failed
     */
