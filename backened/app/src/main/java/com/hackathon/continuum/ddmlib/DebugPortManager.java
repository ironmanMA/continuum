...
/**
 * Centralized point to provide a {@link com.hackathon.continuum.ddmlib.DebugPortManager.IDebugPortProvider} to ddmlib.
 *
 ...
 *
 * <p/>This {@link com.hackathon.continuum.ddmlib.DebugPortManager} allows applications using ddmlib to provide a custom
...
public class DebugPortManager {
    ...
    /**
     * Sets the {@link com.hackathon.continuum.ddmlib.DebugPortManager.IDebugPortProvider} that will be used when a new {@link Client} requests
     * a debugger port.
