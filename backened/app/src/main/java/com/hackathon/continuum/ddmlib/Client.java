...
import com.hackathon.continuum.ddmlib.ClientData.MethodProfilingStatus;
import com.hackathon.continuum.ddmlib.DebugPortManager.IDebugPortProvider;
import com.hackathon.continuum.ddmlib.AndroidDebugBridge.IClientChangeListener;
...
public class Client {
    ...
    /** Client change bit mask: combination of {@link com.hackathon.continuum.ddmlib.Client#CHANGE_NAME},
     * {@link com.hackathon.continuum.ddmlib.Client#CHANGE_DEBUGGER_STATUS}, and {@link com.hackathon.continuum.ddmlib.Client#CHANGE_PORT}.
     */
    ...
    /**
     * Returns a string representation of the {@link com.hackathon.continuum.ddmlib.Client} object.
     */
    @Override
     ...
     * {@link IClientChangeListener#clientChanged(com.hackathon.continuum.ddmlib.Client, int)} with a <code>changeMask</code>
     ...
     * will be received through {@link IClientChangeListener#clientChanged(com.hackathon.continuum.ddmlib.Client, int)}
     ...
     *
     * @see AndroidDebugBridge#setSelectedClient(com.hackathon.continuum.ddmlib.Client)
    ...
    /**
     * Returns whether this {@link com.hackathon.continuum.ddmlib.Client} has a valid connection to the application VM.
     */
