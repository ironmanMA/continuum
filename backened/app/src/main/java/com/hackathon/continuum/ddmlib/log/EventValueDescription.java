...
import com.hackathon.continuum.ddmlib.log.EventContainer.EventValueType;
 ...
 * name, type ({@link EventValueType}), and (if needed) value unit ({@link com.hackathon.continuum.ddmlib.log.EventValueDescription.ValueType}).
 * <p/>
 * The index of the value is not contained within this class, and is instead dependent on the
 * index of this particular object in the array of {@link com.hackathon.continuum.ddmlib.log.EventValueDescription} returned by
...
public final class EventValueDescription {
    ...
    public static enum ValueType {
        ...
        /**
         * Checks that the {@link EventValueType} is compatible with the {@link com.hackathon.continuum.ddmlib.log.EventValueDescription.ValueType}.
        ...
        /**
         * Returns a {@link com.hackathon.continuum.ddmlib.log.EventValueDescription.ValueType} from an integer value, or <code>null</code> if no match
         * were found.
    ...
    /**
     * Builds a {@link com.hackathon.continuum.ddmlib.log.EventValueDescription} with a name and a type.
     * <p/>
     * If the type is {@link EventValueType#INT} or {@link EventValueType#LONG}, the
     * {@link #mValueType} is set to {@link com.hackathon.continuum.ddmlib.log.EventValueDescription.ValueType#BYTES} by default. It set to
     * {@link com.hackathon.continuum.ddmlib.log.EventValueDescription.ValueType#NOT_APPLICABLE} for all other {@link EventValueType} values.
     * @param name
     * @param type
     */
    ...
    /**
     * Builds a {@link com.hackathon.continuum.ddmlib.log.EventValueDescription} with a name and a type, and a {@link com.hackathon.continuum.ddmlib.log.EventValueDescription.ValueType}.
     * <p/>
     * @param name
     * @param type
     * @param valueType
    ...
    /**
     * @return the {@link com.hackathon.continuum.ddmlib.log.EventValueDescription.ValueType}.
     */
